...
Si suponemos que $X$ sigue una distribución gama, y manteniendo el modelo gama para el speckle $Y$, y suponiendo que $X$ e $Y$ son independientes, llegamos a una distribución $K$.
...
Fue propuesta en 1997, y se la considera un ``Modelo Universal'' para datos SAR.
Su densidad es
$$
...
plot(c(0,5), c(10^(-2),10), type="n", axes = FALSE, log = "y", xlab = "Intensidad", ylab = "Densidades GI0 de Media Unitaria",
     main = "Densidades del Retorno Extremamente Heterogéneo - Escala Semilogarítmica")
axis(1)
axis(2)
curve(dGI0(x, -1.5, 0.5, 1), col=colores[3], lwd=3, n = 500, from=0, to=5, add=TRUE)
curve(dGI0(x, -1.5, 0.5, 3), col=colores[2], lwd=3, n = 500, add=TRUE)
...
plot(c(0,3), c(10^(-2),1.5), type="n", axes = FALSE, log = "y", xlab = "Intensidad", ylab = "Densidades GI0 de Media Unitaria",
     main = "Densidades del Retorno Heterogéneo - Escala Semilogarítmica")
axis(1)
axis(2)
curve(dGI0(x, -3, 2, 1), col=colores[3], lwd=3, n = 500, from=0, to=5, add=TRUE)
curve(dGI0(x, -3, 2, 3), col=colores[2], lwd=3, n = 500, add=TRUE)
